...
// The memo text can be used to inform off-chain actions taken
// in response to this transaction completing.
...
transaction(amount: UFix64, to: Address, memo: String) {
    ...
    execute {
        ...
        // Emit the memo (make sure the string isn't too long)
